    ...
    <view class="onb__slide">
        ...
        <view class="onb__photos-section">
            ...
            <view class="onb__photos-grid">
                <view v-for="(p, i) in photos" :key="i" class="onb__photo-cell" :class="{ 'is-cover': i === 0 }"
                    hover-class="onb__photo-cell--press" :hover-stay-time="80" @tap="removePhoto(i)">
                ...
                <view v-if="photos.length < 6" class="onb__photo-cell onb__photo-cell--add"
                    hover-class="onb__photo-cell--press" :hover-stay-time="80" @tap="addPhoto">
        ...
        <view class="onb__field">
            <input class="onb__input" :value="nickname" @input="e => nickname = e.detail.value" placeholder="你的名字或昵称"
                placeholder-class="onb__input-placeholder" maxlength="20" />
        </view>
